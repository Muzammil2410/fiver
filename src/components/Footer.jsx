      ...
      <div className="container-main max-w-[1200px] mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/gigs?category=design" className="hover:text-white transition-colors">
                  Design
                </a>
              </li>
              <li>
                <a href="/gigs?category=development" className="hover:text-white transition-colors">
                  Development
                </a>
              </li>
              <li>
                <a href="/gigs?category=writing" className="hover:text-white transition-colors">
                  Writing
                </a>
              </li>
              <li>

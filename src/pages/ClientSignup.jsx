        ...
        <Card className="w-full max-w-lg mx-auto shadow-xl">
          <div className="p-6 sm:p-8 md:p-10">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3 text-neutral-900">Join as Client</h1>
              <p className="text-sm sm:text-base md:text-lg text-neutral-600">Create your account to browse amazing gigs</p>
            </div>
